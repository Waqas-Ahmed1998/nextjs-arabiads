  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`flex  justify-evenly flex-col mb-5 md:mb-0 xl:mb-auto  ${styles.cardShadow} relative bg-white pt-[30px] pb-[20px] rounded-[30px] md:w-56 md:h-48 h-28`}
        >
          <h3
        ...
        <div
          className={`flex justify-evenly mb-5 md:mb-0   flex-col ${styles.cardShadow} relative bg-white pt-[30px] pb-[20px] rounded-[30px] md:w-56 md:h-48 h-28`}
        >
          <h3
            className={`${styles.montserrat} text-[#316AD8]  text-center text-xl md:text-[40px] tracking-wide [font-weight:700]`}
          >
